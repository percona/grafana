...
describe('UpgradeButton::', () => {
  ...
  it('shows message when upgrade service is unavailable', () => {
    render(<UpgradeButton nextVersion={version} onUpdateStart={onClick} upgradeServiceAvailable={false} />);
  ...
  it("doesn't show message when upgrade service is available", () => {
    render(<UpgradeButton nextVersion={version} onUpdateStart={onClick} upgradeServiceAvailable />);

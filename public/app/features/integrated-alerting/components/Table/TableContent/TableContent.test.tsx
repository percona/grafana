...
describe('TableContent', () => {
  it('should render the loader when data fetch is pending', async () => {
    const wrapper = shallow(<TableContent pending hasData={false} emptyMessage="no data" />);
  ...
  it('should display the noData section when no data is passed', async () => {
    const wrapper = shallow(<TableContent pending={false} hasData={false} emptyMessage="empty" />);

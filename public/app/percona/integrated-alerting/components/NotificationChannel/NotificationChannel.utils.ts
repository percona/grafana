...
export const TO_MODEL = {
  ...
  [NotificationChannelType.webhook]: (channel: NotificationChannelAPI): WebHookNotificationChannel => ({
    ...
    summary: channel.summary,
    disabled: channel.disabled,
    sendResolved: !!channel.webhook_config?.send_resolved,
    ...
    ca: channel.webhook_config?.http_config.tls_config?.ca_file_content,
    cert: channel.webhook_config?.http_config.tls_config?.cert_file_content,
    ...
    maxAlerts: channel.webhook_config?.max_alerts,
  }),
};

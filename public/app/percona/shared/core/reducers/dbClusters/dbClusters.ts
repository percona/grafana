...
import { formatDBClusters } from '../../../../dbaas/components/DBCluster/DBCluster.utils';
...
const perconaDBClustersSlice = createSlice({
  ...
  reducers: {
    setDBClusters: (state, action: PayloadAction<Array<Partial<DBCluster>>>): PerconaDBClustersState => {
      return {
        ...state,

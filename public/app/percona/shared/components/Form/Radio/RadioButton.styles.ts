...
export const getStyles = stylesFactory((theme: GrafanaTheme) => {
  ...
  const textColor = selectThemeVariant({ light: colors.text, dark: palette.gray4 }, theme.type);
  const textColorHover = selectThemeVariant({ light: palette.dark1, dark: palette.white }, theme.type);

...
export const CheckboxField = ({ name, label, required, disabled, dataQa }: CheckboxFieldInterface) => {
  ...
  return (
    <label className={styles.checkboxContainer}>
      <input {...field.input} type="checkbox" required={required} disabled={disabled} data-qa={dataQa} />

...
const PerconaUpdateVersion = () => {
  const { updateAvailable, installed, latest, changeLogs, showUpdateModal, latestNewsUrl } = useSelector(getUpdatesInfo);
      ...
      >
        <div data-testid="one-update-modal">
          ...
          <p className={styles.releaseNotesText}>
            <a target="_blank" rel="noopener noreferrer" href={changeLogs?.updates[0]?.releaseNotesUrl || latestNewsUrl}>

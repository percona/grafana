...
CREATE TABLE
  `alert` (
    ...
    SET
      utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
      `state` varchar(190) CHARACTER
    SET
      utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
      `settings` mediumtext COLLATE utf8mb4_unicode_ci,
      `frequency` bigint NOT NULL,
      `handler` bigint NOT NULL,
      `severity` text CHARACTER
    SET
      utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
      `silenced` tinyint (1) NOT NULL,
      `execution_error` text CHARACTER
    SET
      utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
      `eval_data` text CHARACTER
    SET
...
CREATE TABLE
  `alert_configuration` (
    ...
    `configuration_version` varchar(3) CHARACTER
    SET
      utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
      `created_at` int NOT NULL,
      `default` tinyint (1) NOT NULL DEFAULT '0',
      `org_id` bigint NOT NULL DEFAULT '0',
      `configuration_hash` varchar(32) CHARACTER
    SET
      utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'not-yet-calculated',
      PRIMARY KEY (`id`),
...
CREATE TABLE
  `alert_configuration_history` (
    `id` bigint NOT NULL AUTO_INCREMENT,
    `org_id` bigint NOT NULL DEFAULT '0',
    `alertmanager_configuration` mediumtext CHARACTER
    SET
      utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
      `configuration_hash` varchar(32) CHARACTER
    SET
...
CREATE TABLE
  `alert_image` (
    `id` bigint NOT NULL AUTO_INCREMENT,
    `token` varchar(190) CHARACTER
    SET
      utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
      `path` varchar(190) CHARACTER
    SET
      utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE
  `alert_notification` (
    ...
    SET
      ...
      `uid` varchar(40) CHARACTER
    SET
      utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
      `secure_settings` text CHARACTER
    SET
      utf8mb4 COLLATE utf8mb4_unicode_ci,
      PRIMARY KEY (`id`),
...
CREATE TABLE
  `alert_rule` (
    `id` bigint NOT NULL AUTO_INCREMENT,
    `org_id` bigint NOT NULL,
    `title` varchar(190) CHARACTER
    SET
      utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
      `condition` varchar(190) CHARACTER
    SET
      utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
    ...
    SET
      ...
      `namespace_uid` varchar(40) CHARACTER
    SET
      utf8mb4 COLLATE utf8mb4_bin NOT NULL,
      `rule_group` varchar(190) CHARACTER
    SET
      utf8mb4 COLLATE utf8mb4_bin NOT NULL,
      `no_data_state` varchar(15) CHARACTER
    SET
      utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'NoData',
      `exec_err_state` varchar(15) CHARACTER
    SET
      utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'Alerting',
    ...
    SET
      ...
      KEY `IDX_alert_rule_org_id_namespace_uid_rule_group_rule_group_idx` (
        `org_id`,
        `namespace_uid`,
        `rule_group`,
        `rule_group_idx`
...
CREATE TABLE
  `alert_rule_version` (
    ...
    SET
      utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '0',
      `rule_namespace_uid` varchar(40) CHARACTER
    SET
      utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
      `rule_group` varchar(190) CHARACTER
    SET
    ...
    SET
      ...
      `rule_guid` varchar(36) CHARACTER
    SET
      utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
      `keep_firing_for` bigint NOT NULL DEFAULT '0',
      `missing_series_evals_to_resolve` smallint DEFAULT NULL,
...
CREATE TABLE
  `anon_device` (
    `id` bigint NOT NULL AUTO_INCREMENT,
    `client_ip` varchar(255) CHARACTER
    SET
      utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
      `created_at` datetime NOT NULL,
      `device_id` varchar(127) CHARACTER
    SET
      utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
      `updated_at` datetime NOT NULL,
...
CREATE TABLE
  `cache_data` (
    `cache_key` varchar(168) CHARACTER
    SET
      utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
      `data` blob NOT NULL,
...
CREATE TABLE
  `cloud_migration_resource` (
    ...
    SET
      utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
      `resource_type` varchar(40) CHARACTER
    SET
      utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
      `resource_uid` varchar(255) CHARACTER
    SET
      utf8mb3 COLLATE utf8mb3_general_ci DEFAULT NULL,
      `status` varchar(20) CHARACTER
    SET
      utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
      `error_string` text CHARACTER
    SET
      utf8mb4 COLLATE utf8mb4_unicode_ci,
      `snapshot_uid` varchar(40) CHARACTER
    SET
      utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
      `name` text CHARACTER
    SET
      utf8mb4 COLLATE utf8mb4_unicode_ci,
      `parent_name` text CHARACTER
    SET
      utf8mb4 COLLATE utf8mb4_unicode_ci,
      `error_code` text CHARACTER
    SET
      utf8mb4 COLLATE utf8mb4_unicode_ci,
      PRIMARY KEY (`id`)
  ) ENGINE = InnoDB DEFAULT CHARSET = utf8mb4 COLLATE = utf8mb4_unicode_ci;
...
CREATE TABLE
  `cloud_migration_session` (
    ...
    SET
      ...
      `region_slug` text CHARACTER
    SET
      utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
      `cluster_slug` text CHARACTER
    SET
      utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
      `created` datetime NOT NULL,
      `updated` datetime NOT NULL,
...
CREATE TABLE
  `cloud_migration_snapshot` (
    ...
    SET
      utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
      `session_uid` varchar(40) CHARACTER
    SET
      utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
      `created` datetime NOT NULL,
      `updated` datetime NOT NULL,
      `finished` datetime DEFAULT NULL,
      `upload_url` text CHARACTER
    SET
      utf8mb4 COLLATE utf8mb4_unicode_ci,
      `status` text CHARACTER
    SET
      utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
      `local_directory` text CHARACTER
    SET
      utf8mb4 COLLATE utf8mb4_unicode_ci,
      `gms_snapshot_uid` text CHARACTER
    SET
      utf8mb4 COLLATE utf8mb4_unicode_ci,
      `encryption_key` text CHARACTER
    SET
      utf8mb4 COLLATE utf8mb4_unicode_ci,
      `error_string` text CHARACTER
    SET
      utf8mb4 COLLATE utf8mb4_unicode_ci,
      `resource_storage_type` varchar(255) CHARACTER
    SET
      utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
      `encryption_algo` varchar(255) CHARACTER
    SET
      utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
      `metadata` blob,
      `public_key` blob,
...
CREATE TABLE
  `cloud_migration_snapshot_partition` (
    `snapshot_uid` varchar(40) CHARACTER
    SET
      utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
      `partition_number` int NOT NULL,
      `resource_type` varchar(255) CHARACTER
    SET
      utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
      `data` longblob NOT NULL,
      PRIMARY KEY (
...
CREATE TABLE
  `correlation` (
    ...
    SET
      utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
      `org_id` bigint NOT NULL DEFAULT '0',
      `source_uid` varchar(40) CHARACTER
    SET
      utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
      `target_uid` varchar(40) CHARACTER
    SET
      utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
    ...
    SET
      utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
      `config` text CHARACTER
    SET
      utf8mb4 COLLATE utf8mb4_unicode_ci,
      `provisioned` tinyint (1) NOT NULL DEFAULT '0',
      `type` varchar(40) CHARACTER
    SET
      utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'query',
...
CREATE TABLE
  `dashboard` (
    `id` bigint NOT NULL AUTO_INCREMENT,
    `version` int NOT NULL,
    `slug` varchar(189) CHARACTER
    SET
      utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
      `title` varchar(189) CHARACTER
    SET
      utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
      `data` mediumtext CHARACTER
    SET
      utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
      `org_id` bigint NOT NULL,
      `created` datetime NOT NULL,
      ...
      `plugin_id` varchar(189) CHARACTER
    SET
      utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
    ...
    SET
      ...
      `api_version` varchar(16) CHARACTER
    SET
      utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
      `folder_uid` varchar(40) CHARACTER
    SET
      utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
      PRIMARY KEY (`id`),
...
CREATE TABLE
  `dashboard_provisioning` (
    ...
    SET
      utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
      `external_id` text CHARACTER
    SET
      utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
      `updated` int NOT NULL DEFAULT '0',
      `check_sum` varchar(32) CHARACTER
    SET
      utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
      PRIMARY KEY (`id`),
...
CREATE TABLE
  `dashboard_public` (
    ...
    SET
      utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
      `org_id` bigint NOT NULL,
      `time_settings` text CHARACTER
    SET
      utf8mb4 COLLATE utf8mb4_unicode_ci,
      `template_variables` mediumtext CHARACTER
    SET
      utf8mb4 COLLATE utf8mb4_unicode_ci,
      `access_token` varchar(32) CHARACTER
    SET
      utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
      ...
      `share` varchar(64) CHARACTER
    SET
      utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'public',
      PRIMARY KEY (`uid`),
...
CREATE TABLE
  `dashboard_public_email_share` (
    ...
    SET
      utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
      `public_dashboard_uid` varchar(64) CHARACTER
    SET
      utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
      `recipient` varchar(255) CHARACTER
    SET
      utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
      `type` varchar(64) CHARACTER
    SET
      utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'email',
      `created_at` datetime NOT NULL,
      `updated_at` datetime NOT NULL,
      PRIMARY KEY (`uid`)
  ) ENGINE = InnoDB DEFAULT CHARSET = utf8mb4 COLLATE = utf8mb4_unicode_ci;
...
CREATE TABLE
  `dashboard_public_magic_link` (
    ...
    SET
      utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
      `token_uuid` varchar(64) CHARACTER
    SET
      utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
      `public_dashboard_uid` varchar(64) CHARACTER
    SET
...
CREATE TABLE
  `dashboard_public_session` (
    ...
    SET
      utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
      `cookie_uuid` varchar(64) CHARACTER
    SET
      utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
      `public_dashboard_uid` varchar(64) CHARACTER
    SET
...
CREATE TABLE
  `dashboard_public_usage_by_day` (
    `id` bigint NOT NULL AUTO_INCREMENT,
    `public_dashboard_uid` varchar(255) CHARACTER
    SET
      utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
      `day` varchar(40) CHARACTER
    SET
      utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE
  `dashboard_snapshot` (
    ...
    SET
      utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
      `delete_key` varchar(190) CHARACTER
    SET
      utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
      `org_id` bigint NOT NULL,
      `user_id` bigint NOT NULL,
      `external` tinyint (1) NOT NULL,
      `external_url` varchar(255) CHARACTER
    SET
      utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
      `dashboard` mediumtext CHARACTER
    SET
      utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
      `expires` datetime NOT NULL,
      `created` datetime NOT NULL,
      `updated` datetime NOT NULL,
      `external_delete_url` varchar(255) CHARACTER
    SET
      utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE
  `data_keys` (
    ...
    SET
      ...
      `scope` varchar(30) CHARACTER
    SET
      utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
      `provider` varchar(50) CHARACTER
    SET
      utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
      `encrypted_data` blob NOT NULL,
      `created` datetime NOT NULL,
      `updated` datetime NOT NULL,
      `label` varchar(100) CHARACTER
    SET
      utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
      PRIMARY KEY (`name`)
  ) ENGINE = InnoDB DEFAULT CHARSET = utf8mb4 COLLATE = utf8mb4_unicode_ci;
...
CREATE TABLE
  `data_source` (
    ...
    SET
      utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
      `user` varchar(255) CHARACTER
    SET
      utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
      `database` varchar(255) CHARACTER
    SET
      utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
      `basic_auth` tinyint (1) NOT NULL,
      `basic_auth_user` varchar(255) CHARACTER
    SET
      utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
      `basic_auth_password` varchar(255) CHARACTER
    SET
      utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
    ...
    SET
      ...
      `api_version` varchar(20) CHARACTER
    SET
      utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
      PRIMARY KEY (`id`),
...
CREATE TABLE
  `data_source_cache` (
    ...
    `data_source_uid` varchar(40) CHARACTER
    SET
      utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '0',
...
CREATE TABLE
  `entity_event` (
    `id` bigint NOT NULL AUTO_INCREMENT,
    `entity_id` varchar(1024) CHARACTER
    SET
      utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
      `event_type` varchar(8) CHARACTER
    SET
      utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE
  `file` (
    `path` varchar(1024) CHARACTER
    SET
      utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
      `path_hash` varchar(64) CHARACTER
    SET
      utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
      `parent_folder_path_hash` varchar(64) CHARACTER
    SET
      utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
      `contents` mediumblob,
      `etag` varchar(32) CHARACTER
    SET
      utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
      `cache_control` varchar(128) CHARACTER
    SET
      utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
      `content_disposition` varchar(128) CHARACTER
    SET
      utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
      `updated` datetime NOT NULL,
      `created` datetime NOT NULL,
      `size` bigint NOT NULL,
      `mime_type` varchar(255) CHARACTER
    SET
      utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE
  `folder` (
    ...
    SET
      utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
      `parent_uid` varchar(40) CHARACTER
    SET
      utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
      `created` datetime NOT NULL,
      `updated` datetime NOT NULL,
...
CREATE TABLE
  `kv_store` (
    `id` bigint NOT NULL AUTO_INCREMENT,
    `org_id` bigint NOT NULL,
    `namespace` varchar(190) CHARACTER
    SET
      utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
      `key` varchar(190) CHARACTER
    SET
...
CREATE TABLE
  `library_element` (
    ...
    SET
      utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
      `description` varchar(2048) CHARACTER
    SET
      utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE
  `login_attempt` (
    `id` bigint NOT NULL AUTO_INCREMENT,
    `username` varchar(190) CHARACTER
    SET
      utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE
  `migration_log` (
    `id` bigint NOT NULL AUTO_INCREMENT,
    `migration_id` varchar(255) CHARACTER
    SET
      utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
      `sql` text CHARACTER
    SET
...
CREATE TABLE
  `org` (
    ...
    SET
      utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
      `address1` varchar(255) CHARACTER
    SET
      utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
      `address2` varchar(255) CHARACTER
    SET
      utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
    ...
    SET
      utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
      `zip_code` varchar(50) CHARACTER
    SET
      utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
      `country` varchar(255) CHARACTER
    SET
      utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
      `billing_email` varchar(255) CHARACTER
    SET
      utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
      `created` datetime NOT NULL,
      `updated` datetime NOT NULL,
...
CREATE TABLE
  `permission` (
    `id` bigint NOT NULL AUTO_INCREMENT,
    `role_id` bigint NOT NULL,
    `action` varchar(190) CHARACTER
    SET
      utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
      `scope` varchar(190) CHARACTER
    SET
      utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
      `created` datetime NOT NULL,
      `updated` datetime NOT NULL,
      `kind` varchar(40) CHARACTER
    SET
      utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
      `attribute` varchar(40) CHARACTER
    SET
      utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
      `identifier` varchar(40) CHARACTER
    SET
      utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
      PRIMARY KEY (`id`),
...
CREATE TABLE
  `playlist` (
    ...
    SET
      utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
      `interval` varchar(255) CHARACTER
    SET
      utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
      `org_id` bigint NOT NULL,
      `created_at` bigint NOT NULL DEFAULT '0',
      `updated_at` bigint NOT NULL DEFAULT '0',
      `uid` varchar(80) CHARACTER
    SET
      utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '0',
      PRIMARY KEY (`id`),
...
CREATE TABLE
  `plugin_setting` (
    `id` bigint NOT NULL AUTO_INCREMENT,
    `org_id` bigint NOT NULL DEFAULT '1',
    `plugin_id` varchar(190) CHARACTER
    SET
      utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
      `enabled` tinyint (1) NOT NULL,
      `pinned` tinyint (1) NOT NULL,
      `json_data` text CHARACTER
    SET
      utf8mb4 COLLATE utf8mb4_unicode_ci,
      `secure_json_data` text CHARACTER
    SET
      utf8mb4 COLLATE utf8mb4_unicode_ci,
      `created` datetime NOT NULL,
      `updated` datetime NOT NULL,
      `plugin_version` varchar(50) CHARACTER
    SET
      utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
      PRIMARY KEY (`id`),
...
CREATE TABLE
  `preferences` (
    ...
    `timezone` varchar(50) CHARACTER
    SET
      utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
      `theme` varchar(20) CHARACTER
    SET
      utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
      `created` datetime NOT NULL,
      `updated` datetime NOT NULL,
      `team_id` bigint DEFAULT NULL,
      `week_start` varchar(10) CHARACTER
    SET
      utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
      `json_data` mediumtext COLLATE utf8mb4_unicode_ci,
      `home_dashboard_uid` varchar(40) CHARACTER
    SET
      utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
      PRIMARY KEY (`id`),
...
CREATE TABLE
  `provenance_type` (
    `id` bigint NOT NULL AUTO_INCREMENT,
    `org_id` bigint NOT NULL,
    `record_key` varchar(190) CHARACTER
    SET
      utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
      `record_type` varchar(190) CHARACTER
    SET
      utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
      `provenance` varchar(190) CHARACTER
    SET
      utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
      PRIMARY KEY (`id`),
...
CREATE TABLE
  `query_history` (
    ...
    SET
      utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
      `org_id` bigint NOT NULL,
      `datasource_uid` varchar(40) CHARACTER
    SET
      utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE
  `query_history_details` (
    `id` bigint NOT NULL AUTO_INCREMENT,
    `query_history_item_uid` varchar(40) CHARACTER
    SET
      utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
      `datasource_uid` varchar(40) CHARACTER
    SET
...
CREATE TABLE
  `query_history_star` (
    `id` bigint NOT NULL AUTO_INCREMENT,
    `query_uid` varchar(40) CHARACTER
    SET
      utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
      `user_id` bigint DEFAULT NULL,
      `org_id` bigint NOT NULL DEFAULT '1',
...
CREATE TABLE
  `recording_rules` (
    `id` varchar(128) CHARACTER
    SET
      utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
      `target_ref_id` varchar(128) CHARACTER
    SET
      utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
    ...
    SET
      ...
      `created_at` datetime NOT NULL,
      `prom_name` varchar(128) CHARACTER
    SET
      utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE
  `remote_write_targets` (
    ...
    SET
      utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
      `data_source_uid` varchar(128) CHARACTER
    SET
      utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
      `write_path` varchar(128) CHARACTER
    SET
      utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
      `org_id` int NOT NULL,
...
CREATE TABLE
  `report` (
    ...
    SET
      utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
      `recipients` text CHARACTER
    SET
      utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
      `reply_to` text CHARACTER
    SET
      utf8mb4 COLLATE utf8mb4_unicode_ci,
      `message` text CHARACTER
    SET
      utf8mb4 COLLATE utf8mb4_unicode_ci,
      `schedule_frequency` varchar(32) CHARACTER
    SET
      utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
      `schedule_day` varchar(32) CHARACTER
    SET
      utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
      ...
      `created` datetime NOT NULL,
      `updated` datetime NOT NULL,
      `schedule_timezone` varchar(50) CHARACTER
    SET
      utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'Europe/Stockholm',
      `time_from` varchar(255) CHARACTER
    SET
      utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
      `time_to` varchar(255) CHARACTER
    SET
      utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
      `pdf_landscape` tinyint (1) DEFAULT NULL,
      `schedule_day_of_month` varchar(32) CHARACTER
    SET
      utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
      `pdf_layout` varchar(255) CHARACTER
    SET
      utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
      `pdf_orientation` varchar(32) CHARACTER
    SET
      utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
      `dashboard_uid` varchar(40) CHARACTER
    SET
      utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
      `template_vars` text CHARACTER
    SET
      utf8mb4 COLLATE utf8mb4_unicode_ci,
      `enable_dashboard_url` tinyint (1) DEFAULT NULL,
      `state` varchar(32) CHARACTER
    SET
      utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
      `enable_csv` tinyint (1) DEFAULT NULL,
      `schedule_start` int DEFAULT NULL,
      `schedule_end` int DEFAULT NULL,
      `schedule_interval_frequency` varchar(32) CHARACTER
    SET
      utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
      `schedule_interval_amount` bigint DEFAULT NULL,
      `schedule_workdays_only` tinyint (1) DEFAULT NULL,
      `formats` varchar(190) CHARACTER
    SET
      utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '["pdf"]',
...
CREATE TABLE
  `report_dashboards` (
    ...
    SET
      utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
      `report_variables` text CHARACTER
    SET
      utf8mb4 COLLATE utf8mb4_unicode_ci,
      `time_to` varchar(255) CHARACTER
    SET
...
CREATE TABLE
  `report_settings` (
    ...
    `user_id` bigint NOT NULL,
    `org_id` bigint NOT NULL,
    `branding_report_logo_url` text CHARACTER
    SET
      utf8mb4 COLLATE utf8mb4_unicode_ci,
      `branding_email_logo_url` text CHARACTER
    SET
      utf8mb4 COLLATE utf8mb4_unicode_ci,
      `branding_email_footer_link` text CHARACTER
    SET
      utf8mb4 COLLATE utf8mb4_unicode_ci,
      `branding_email_footer_text` text CHARACTER
    SET
      utf8mb4 COLLATE utf8mb4_unicode_ci,
      `branding_email_footer_mode` varchar(50) CHARACTER
    SET
      utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
      `pdf_theme` varchar(40) CHARACTER
    SET
      utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'light',
      `embedded_image_theme` varchar(40) CHARACTER
    SET
      utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'dark',
      PRIMARY KEY (`id`)
  ) ENGINE = InnoDB DEFAULT CHARSET = utf8mb4 COLLATE = utf8mb4_unicode_ci;
...
CREATE TABLE
  `resource` (
    ...
    SET
      ...
      `group` varchar(190) CHARACTER
    SET
      utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
      `resource` varchar(190) CHARACTER
    SET
      utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
      `namespace` varchar(63) CHARACTER
    SET
      utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
      `name` varchar(253) CHARACTER
    SET
      utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
    ...
    SET
      utf8mb4 COLLATE utf8mb4_unicode_ci,
      `action` int NOT NULL,
      `label_set` varchar(64) CHARACTER
    SET
      utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
      `previous_resource_version` bigint DEFAULT NULL,
      `folder` varchar(253) CHARACTER
    SET
      utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
      PRIMARY KEY (`guid`),
...
CREATE TABLE
  `resource_blob` (
    ...
    SET
      utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
      `content_type` varchar(255) CHARACTER
    SET
      utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
      PRIMARY KEY (`uuid`),
...
CREATE TABLE
  `resource_events` (
    `key_path` varchar(2048) CHARACTER
    SET
...
CREATE TABLE
  `resource_history` (
    ...
    SET
      ...
      PRIMARY KEY (`guid`),
      UNIQUE KEY `UQE_resource_history_namespace_group_name_version` (
        `namespace`,
        `group`,
        `resource`,
        `name`,
      ...
      KEY `IDX_resource_history_namespace_group_resource_action_version` (
        `namespace`,
        `group`,
        `resource`,
        `action`,
      ...
      KEY `IDX_resource_history_namespace_group_resource_name_generation` (
        `namespace`,
        `group`,
        `resource`,
        `name`,
...
CREATE TABLE
  `role` (
    ...
    SET
      ...
      `created` datetime NOT NULL,
      `updated` datetime NOT NULL,
      `display_name` varchar(190) CHARACTER
    SET
      utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
      `group_name` varchar(190) CHARACTER
    SET
      utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE
  `secret_data_key` (
    `uid` varchar(100) CHARACTER
    SET
      utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
      `namespace` varchar(253) CHARACTER
    SET
      utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
      `label` varchar(100) CHARACTER
    SET
...
CREATE TABLE
  `secret_encrypted_value` (
    ...
    SET
      ...
      `data_key_id` varchar(100) CHARACTER
    SET
      utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
...
CREATE TABLE
  `secret_keeper` (
    ...
    SET
      utf8mb4 COLLATE utf8mb4_unicode_ci,
      `created` bigint NOT NULL,
      `created_by` text CHARACTER
    SET
      utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
      `updated` bigint NOT NULL,
      `updated_by` text CHARACTER
    SET
      utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
      `description` varchar(253) CHARACTER
    SET
      utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
      `type` text CHARACTER
    SET
...
CREATE TABLE
  `secret_secure_value` (
    ...
    SET
      utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
      `keeper` varchar(253) CHARACTER
    SET
      utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
      `decrypters` text CHARACTER
    SET
      utf8mb4 COLLATE utf8mb4_unicode_ci,
      `ref` varchar(1024) CHARACTER
    SET
      utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
      `owner_reference_api_group` varchar(253) CHARACTER
    SET
      utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
      `owner_reference_api_version` varchar(253) CHARACTER
    SET
      utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
      `owner_reference_kind` varchar(253) CHARACTER
    SET
      utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
      `owner_reference_name` varchar(253) CHARACTER
    SET
      utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
      `lease_token` varchar(36) CHARACTER
    SET
      utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE
  `secrets` (
    `id` bigint NOT NULL AUTO_INCREMENT,
    `org_id` bigint NOT NULL,
    `namespace` varchar(255) CHARACTER
    SET
      utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
      `type` varchar(255) CHARACTER
    SET
...
CREATE TABLE
  `seed_assignment` (
    ...
    `builtin_role` varchar(190) CHARACTER
    SET
      utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE
  `server_lock` (
    `id` bigint NOT NULL AUTO_INCREMENT,
    `operation_uid` varchar(100) CHARACTER
    SET
      utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
      `version` bigint NOT NULL,
...
CREATE TABLE
  `setting` (
    `section` varchar(100) CHARACTER
    SET
      utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
      `key` varchar(100) CHARACTER
    SET
      utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
      `value` text CHARACTER
    SET
      utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
      `encrypted_value` text CHARACTER
    SET
      utf8mb4 COLLATE utf8mb4_unicode_ci,
...
CREATE TABLE
  `signing_key` (
    `id` bigint NOT NULL AUTO_INCREMENT,
    `key_id` varchar(255) CHARACTER
    SET
      utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
      `private_key` text CHARACTER
    SET
      utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
      `added_at` datetime NOT NULL,
      `expires_at` datetime DEFAULT NULL,
      `alg` varchar(255) CHARACTER
    SET
      utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
      PRIMARY KEY (`id`),
...
CREATE TABLE
  `sso_setting` (
    ...
    SET
      utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
      `provider` varchar(255) CHARACTER
    SET
      utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE
  `team` (
    ...
    SET
      utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
      `external_uid` varchar(256) CHARACTER
    SET
      utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
      `is_provisioned` tinyint (1) DEFAULT NULL,
      `email` varchar(190) CHARACTER
    SET
      utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
      PRIMARY KEY (`id`),
...
CREATE TABLE
  `team_group` (
    ...
    `org_id` bigint NOT NULL,
    `team_id` bigint NOT NULL,
    `group_id` varchar(190) CHARACTER
    SET
      utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
      `created` datetime NOT NULL,
      `updated` datetime NOT NULL,
...
CREATE TABLE
  `temp_user` (
    ...
    SET
      ...
      `remote_addr` varchar(255) CHARACTER
    SET
      utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE
  `test_data` (
    `id` int NOT NULL AUTO_INCREMENT,
    `metric1` varchar(20) CHARACTER
    SET
      utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
      `metric2` varchar(150) CHARACTER
    SET
      utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE
  `user` (
    ...
    SET
      utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
      `rands` varchar(50) CHARACTER
    SET
      utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
      `company` varchar(255) CHARACTER
    SET
      utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
      `org_id` bigint NOT NULL,
      `is_admin` tinyint (1) NOT NULL,
      `email_verified` tinyint (1) DEFAULT NULL,
      `theme` varchar(255) CHARACTER
    SET
      utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
      `created` datetime NOT NULL,
      `updated` datetime NOT NULL,
...
CREATE TABLE
  `user_auth` (
    `id` bigint NOT NULL AUTO_INCREMENT,
    `user_id` bigint NOT NULL,
    `auth_module` varchar(190) CHARACTER
    SET
      utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
      `auth_id` varchar(190) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
      `created` datetime NOT NULL,
      `o_auth_access_token` text CHARACTER
    SET
      utf8mb4 COLLATE utf8mb4_unicode_ci,
      `o_auth_refresh_token` text CHARACTER
    SET
      utf8mb4 COLLATE utf8mb4_unicode_ci,
      `o_auth_token_type` text CHARACTER
    SET
      utf8mb4 COLLATE utf8mb4_unicode_ci,
      `o_auth_expiry` datetime DEFAULT NULL,
      `o_auth_id_token` text CHARACTER
    SET
      utf8mb4 COLLATE utf8mb4_unicode_ci,
      `external_uid` text CHARACTER
    SET
      utf8mb4 COLLATE utf8mb4_unicode_ci,
      PRIMARY KEY (`id`),
...
CREATE TABLE
  `user_auth_token` (
    `id` bigint NOT NULL AUTO_INCREMENT,
    `user_id` bigint NOT NULL,
    `auth_token` varchar(100) CHARACTER
    SET
      utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
      `prev_auth_token` varchar(100) CHARACTER
    SET
      utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
      `user_agent` varchar(255) CHARACTER
    SET
...
CREATE TABLE
  `user_external_session` (
    ...
    SET
      utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
      `access_token` text CHARACTER
    SET
      utf8mb4 COLLATE utf8mb4_unicode_ci,
      `id_token` text CHARACTER
    SET
      utf8mb4 COLLATE utf8mb4_unicode_ci,
      `refresh_token` text CHARACTER
    SET
      utf8mb4 COLLATE utf8mb4_unicode_ci,
      `session_id` varchar(1024) CHARACTER
    SET
      utf8mb3 COLLATE utf8mb3_general_ci DEFAULT NULL,
      `session_id_hash` char(44) CHARACTER
    SET
      utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
      `name_id` varchar(1024) CHARACTER
    SET
      utf8mb3 COLLATE utf8mb3_general_ci DEFAULT NULL,
      `name_id_hash` char(44) CHARACTER
    SET
      utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
      `expires_at` datetime DEFAULT NULL,
      `created_at` datetime NOT NULL,
...
CREATE TABLE
  `user_role` (
    ...
    `role_id` bigint NOT NULL,
    `created` datetime NOT NULL,
    `group_mapping_uid` varchar(40) CHARACTER
    SET
      utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT '',
      PRIMARY KEY (`id`),
      UNIQUE KEY `UQE_user_role_org_id_user_id_role_id_group_mapping_uid` (
        `org_id`,
        `user_id`,
        `role_id`,
        `group_mapping_uid`
...
CREATE TABLE
  `user_stats` (
    `id` bigint NOT NULL AUTO_INCREMENT,
    `user_id` bigint NOT NULL,
    `billing_role` varchar(40) CHARACTER
    SET
      utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
      `created` datetime NOT NULL,
      `updated` datetime NOT NULL,
